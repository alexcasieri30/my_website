...
minimax_functions.fillBoard(1, 'x');
console.log(minimax_functions.getBoard());
...
minimax_functions.fillBoard(5, 'x');
console.log(minimax_functions.getBoard());

console.log('step 3');

c = minimax_functions.findBestMove(minimax_functions.getBoard());
grid_pos = minimax_functions.getNum(c);
console.log(grid_pos);
minimax_functions.fillBoard(grid_pos, 'o');
console.log(minimax_functions.getBoard());
